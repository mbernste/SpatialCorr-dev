...
def main():
    ...
    meta_df = pd.read_csv('../GSM4565824_P4_rep1_data/spatial/tissue_positions_list.csv')
    ...
    df_bayes = pd.read_csv(f'../GSM4565824_P4_rep1_data/BayesSpace/BayesSpace_output.{n_clust}_clusts.tsv', sep='\t', index_col=0)
    ...
    df_dino = pd.read_csv('../GSM4565824_P4_rep1_data/dino/GSM4565824_P4_rep1.dino.tsv.gz', sep='\t', index_col=0)
    ...
    adata_counts = sc.read_10x_mtx('../GSM4565824_P4_rep1_data/filtered_feature_bc_matrix')
