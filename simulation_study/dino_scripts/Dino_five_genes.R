...
normDat <- rbind(t(rawDat[, c("count_gene_0", "count_gene_1", "count_gene_2", "count_gene_3", "count_gene_4")]), 1)
colnames(normDat) <- rawDat$X
rownames(normDat) <- c("Gene_1", "Gene_2", "Gene_3", "Gene_4", "Gene_5", "Null_Gene")
