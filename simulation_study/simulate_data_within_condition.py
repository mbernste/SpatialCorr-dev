...
def main():
    ...
    for dataset_i in range(n_datasets):
        ...
        # Simulate dataset
        sim_corrs, sim_covs, adata_sim = simulate_data.simulate_pairwise_condition_covariate_from_dataset(
            adata_raw,
            config['cluster_to_z_means'],
        ...
        sim_X = ndr.normalize(adata_sim.X, umi_counts=umi_counts)
